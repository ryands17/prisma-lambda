...
!(function (e, t) {
  ...
  var i = function (e) {
    ...
    y = function (e, t) {
      if (!m(e)) return e
      var n, i
      if (t && 'function' == typeof (n = e.toString) && !m((i = n.call(e))))
        return i
  ...
  var ee,
    ...
    ge = function (e) {
      return function (t, n, i) {
        ...
        if (e && n != n) {
          ...
          for (; o > s; s++) if ((e || s in a) && a[s] === n) return e || s || 0
        return !e && -1
      }
    },
    ...
    qe = function (e) {
      return (
        w(Fe, e) ||
          (ze && w(Ue, e) ? (Fe[e] = Ue[e]) : (Fe[e] = Be('Symbol.' + e))),
        Fe[e]
      )
    },
    We = qe('species'),
  ...
  Xe
    ...
    : Ve &&
      (!(ee = Ve.match(/Edge\/(\d+)/)) || ee[1] >= 74) &&
      (ee = Ve.match(/Chrome\/(\d+)/)) &&
      (te = ee[1])
  var Ye = te && +te,
    Ge = qe('species'),
    Je = function (e) {
    ...
    ft = function (e, t) {
      ...
      return (dt[e] =
        ...
        !a(function () {
          if (i && !o) return !0
          var e = { length: -1 }
          i ? ct(e, 1, { enumerable: !0, get: ht }) : (e[1] = 1),
            n.call(e, r, s)
        }))
    },
    vt = lt.forEach,
  ...
  var St =
    ...
    At =
      ...
      a(function () {
        ...
        ? function (e, t) {
            for (
              var n = De(e), i = arguments.length, r = 1, a = Ee.f, s = u.f;
              i > r;
        ...
        : Et
  Oe(
    { target: 'Object', stat: !0, forced: Object.assign !== At },
    { assign: At }
  )
  var Rt,
    xt = o
      ...
      : function (e, t) {
          L(e)
          for (var n, i = St(t), r = i.length, a = 0; r > a; )
            P.f(e, (n = i[a++]), t[n])
          return e
        },
  ...
  var It =
    ...
    Bt = function (e, t, n) {
      e &&
        !w((e = n ? e : e.prototype), Ut) &&
        Ft(e, Ut, { configurable: !0, value: t })
    },
    qt = lt.forEach,
    Wt = K('hidden'),
    _t = 'Symbol',
    ...
    cn = function (e, t) {
      ...
      return (
        Kt(n, { type: _t, tag: e, description: t }), o || (n.description = t), n
      )
    },
    dn = He
      ? function (e) {
    ...
    hn = function (e, t, n) {
      ...
      return (
        ...
        w(tn, i)
          ? (n.enumerable
              ? (w(e, Wt) && e[Wt][i] && (e[Wt][i] = !1),
                (n = It(n, { enumerable: c(0, !1) })))
    ...
    gn = function (e, t) {
      ...
      if (n !== Xt || !w(tn, i) || w(nn, i)) {
        var r = Jt(n, i)
        return (
          !r || !w(tn, i) || (w(n, Wt) && n[Wt][i]) || (r.enumerable = !0), r
        )
      }
    },
    pn = function (e) {
  ...
  if (
      ...
      (ie(
        (Yt = function () {
          ...
          var e =
            ...
            n = function (e) {
              this === Xt && n.call(nn, e),
                w(this, Wt) && w(this[Wt], t) && (this[Wt][t] = !1),
                un(this, t, c(1, e))
            }
    ...
    Oe(
      ...
      { getOwnPropertyNames: pn, getOwnPropertySymbols: mn }
    ),
    Oe(
      {
        target: 'Object',
          ...
          if (((i = t), (m(t) || void 0 !== e) && !dn(e)))
            return (
              Te(t) ||
                (t = function (e, t) {
                  if (
                    ('function' == typeof i && (t = i.call(this, e, t)), !dn(t))
                  )
                    return t
                }),
              (r[1] = t),
  ...
  Yt.prototype[Vt] || N(Yt.prototype, Vt, Yt.prototype.valueOf),
    Bt(Yt, _t),
    ($[Wt] = !0)
  var bn = P.f,
    wn = r.Symbol
  if (
    o &&
    'function' == typeof wn &&
    (!('description' in wn.prototype) || void 0 !== wn().description)
  ) {
    var Sn = {},
      En = function () {
        var e =
    ...
    { target: 'Array', stat: !0, forced: _n },
    {
      from: function (e) {
        var t,
          ...
          f = 0
        if (
          (d && (c = at(c, u > 2 ? arguments[2] : void 0, 2)),
          null == h || (l == Array && Mn(h)))
        )
          for (n = new l((t = de(s.length))); t > f; f++)
            (o = d ? c(s[f], f) : s[f]), je(n, f, o)
        else
          for (
  ...
  Oe(
    { target: 'Array', proto: !0, forced: $n || !Xn || !Yn },
    {
      indexOf: function (e) {
        return $n
          ? Kn.apply(this, arguments) || 0
          : Vn(this, e, arguments.length > 1 ? arguments[1] : void 0)
      },
    }
  )
  var Gn = Je('splice'),
  ...
  var si =
    ...
    hi = RegExp(ci + ci + '*$'),
      ...
      return function (t) {
        var n = String(g(t))
        return (
          1 & e && (n = n.replace(di, '')), 2 & e && (n = n.replace(hi, '')), n
        )
      }
    },
    ...
    Ti = n(function (e) {
      ...
      ;(e.exports = function (e, n, i, r, a) {
        ...
        if (a) o = e
          ...
          if ('function' != typeof (s = Hn(e)))
            throw TypeError('Target is not iterable')
          if (Mn(s)) {
            for (l = 0, u = de(e.length); u > l; l++)
              if (
                (c = r ? f(L((h = e[l]))[0], h[1]) : f(e[l])) &&
                c instanceof t
              )
                return c
            return new t(!1)
        ...
        for (d = o.next; !(h = d.call(o)).done; )
          if (
            'object' == typeof (c = Ln(o, f, h.value, r)) &&
            c &&
            c instanceof t
          )
            return c
  ...
  ;(Fi && Ui) ||
    ...
    'process' == h(Bi)
      ...
      : qi && !zi
      ? ((Mi = (Ni = new qi()).port2),
        (Ni.port1.onmessage = Yi),
        (Pi = at(Mi.postMessage, Mi, 1)))
      : !r.addEventListener ||
  ...
  var vr,
    ...
    Fr = Me(Rr, function () {
      ...
      return (
        ((e.constructor = {})[Ar] = t), !(e.then(function () {}) instanceof t)
      )
    }),
    Ur =
      Fr ||
            ...
            try {
              d
                ? (a || (2 === t.rejection && Kr(e, t), (t.rejection = 1)),
                  !0 === d
                    ? (s = r)
                    : (v && v.enter(), (s = d(r)), v && (v.exit(), (u = !0))),
                  s === c.promise
                    ? f(Nr('Promise-chain cycle'))
                    : (l = Br(s))
                    ? l.call(s, h, f)
                    : h(s))
                : f(r)
    ...
    Wr = function (e, t, n) {
      var i, a
      zr
        ? (((i = Mr.createEvent('Event')).promise = t),
          (i.reason = n),
          i.initEvent(e, !1, !0),
          r.dispatchEvent(i))
  ...
  Fr &&
    ...
    (gr = function () {
      var e = new vr(),
        t = xr(e)
      ;(this.promise = e),
        (this.resolve = $r(Yr, e, t)),
        (this.reject = $r(Xr, e, t))
    }),
    (wr.f = Tr =
      function (e) {
  ...
  ;[].keys &&
    ('next' in (ca = [].keys())
      ? (ua = pa(pa(ca))) !== Object.prototype && (la = ua)
      : (ya = !0)),
    null == la && (la = {}),
    w(la, ma) ||
      N(la, ma, function () {
    ...
    if (
      (m &&
        ...
        Ea !== Object.prototype &&
          s.next &&
          (pa(s) !== Ea &&
            (si ? si(s, Ea) : 'function' != typeof s[Aa] && N(s, Aa, Ca)),
          Bt(s, h, !0))),
      r == xa &&
        g &&
        g.name !== xa &&
    ...
    return [
      ...
      function (e) {
        ...
        for (var s, l = [], u = 0; null !== (s = qa(r, a)); ) {
          var c = String(s[0])
          ;(l[u] = c),
            '' === c && (r.lastIndex = Ba(a, de(r.lastIndex), o)),
            u++
        }
        return 0 === u ? null : l
      },
        ...
        [
          ...
          function (e, r) {
            ...
            for (var f = 0, v = 0, g = []; v < s.length; ) {
              ...
              if (
                null === m ||
                (p = Va(de(d.lastIndex + ($a ? 0 : v)), s.length)) === f
              )
                v = Ba(s, v, u)
              else {
  ...
  Fa('search', 1, function (e, t, n) {
    return [
      ...
      function (e) {
        ...
        var s = qa(r, a)
        return (
          bo(r.lastIndex, o) || (r.lastIndex = o), null === s ? -1 : s.index
        )
      },
    ]
  })
  var wo = function (e, t) {
    ...
    Oo =
      /(iphone|ipod|ipad|android)/gi.test(Mo) ||
      ('MacIntel' === navigator.platform && navigator.maxTouchPoints > 1),
    To = /chrome/i.test(Mo) && !/edge/i.test(Mo),
    Do = /android/gi.test(Mo),
    jo =
      'zoom' in Io.style && !Oo && (To || /Version\/[\d\.]+.*Safari/.test(Mo)),
    zo = t(
      n(function (e, t) {
        ...
        t.default = (function (e) {
          if (e) {
            var t = function (e) {
              ...
              k = function (e) {
                e.observeMutations &&
                  ((e.observer = new MutationObserver(b(e, r))),
              ...
              x = function () {
                e.clearTimeout(R),
                  (R = e.setTimeout(c(a), P.observeWindowDelay))
              },
          ...
          function P(e) {
            ...
            return 'string' == typeof e
              ? C(t(document.querySelectorAll(e)), n)
              : C([e], n)[0]
          }
        ...
        no(e, [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              Array.from(
                e.querySelectorAll('.r-fit-text:not([data-fitted])')
              ).forEach(function (e) {
                ;(e.dataset.fitted = ''),
                  zo(e, {
                    minSize: 24,
            ...
            value: function (e) {
              ...
              ;(n = wo({ unloadIframes: !0 }, n)),
                e &&
                  ...
                  So(e, 'iframe[src*="youtube.com/embed/"]').forEach(function (
                    e
                  ) {
                    !e.hasAttribute('data-ignore') &&
                      e.contentWindow &&
                  ...
                  So(e, 'iframe[src*="player.vimeo.com/"]').forEach(function (
                    e
                  ) {
                    !e.hasAttribute('data-ignore') &&
                      e.contentWindow &&
          ...
          },
          {
            ...
            value: function (e) {
              ...
              i.background &&
                ...
                e.hasAttribute('data-preload') &&
                  t.setAttribute('data-preload', ''),
  ...
  Oe(
    { target: 'Array', proto: !0, forced: !Qo || !Zo },
    {
      slice: function (e, t) {
        ...
        for (
          i = new (void 0 === n ? Array : n)(ns(l - s, 0)), r = 0;
          s < l;
          s++, r++
        )
          s in a && je(i, r, a[s])
        ...
        no(e, [
          {
            ...
            value: function (e, t) {
              ...
              if (
                ...
                i.slideDirection =
                  r.indexOf(t) > r.indexOf(e) ? 'forward' : 'backward'
            ...
            value: function (e, t, n, i, r) {
              ...
              t.classList.contains('fragment') &&
                ...
                e.classList.contains('fragment') &&
                  (e.className.match(fo) || [''])[0] ===
                    (t.className.match(fo) || [''])[0] &&
      ...
      return (
        no(e, [
          ...
          },
          {
            key: 'disable',
            value: function () {
              So(this.Reveal.getSlidesElement(), '.fragment').forEach(function (
                e
              ) {
          ...
          },
          {
            ...
            value: function () {
              ...
              if (!/^[0-9]*$/.test(r[0]) && a.length) {
                ...
                e.fragmentInURL &&
                  ((c = parseInt(r[2], 10)), isNaN(c) && (c = void 0)),
                  (h === t.h && f === t.v && void 0 === c) ||
                    this.Reveal.slide(h, f, c)
              }
            },
          },
          {
              ...
              So(this.Reveal.getRevealElement(), lo).forEach(function (e) {
                ...
                So(this.Reveal.getRevealElement(), lo).forEach(function (t) {
                  if (!1 === t.classList.contains('stack')) {
                    ...
                    ;((1 === (c = Math.min(c, e.pdfMaxPagesPerSlide)) &&
                      e.center) ||
                    ...
                    if (
                      ...
                      t.slideBackgroundElement &&
                        d.insertBefore(t.slideBackgroundElement, t),
                      e.showNotes)
                    ) {
                    ...
                    if (e.pdfSeparateFragments) {
                      var p,
                        m,
                        y = this.Reveal.fragments.sort(
                          d.querySelectorAll('.fragment'),
                          !0
                        )
                      y.forEach(function (e) {
                        ...
                        var t = d.cloneNode(!0)
                        d.parentNode.insertBefore(t, (m || d).nextSibling),
                          (p = e),
                          (m = t)
                      }, this),
                        y.forEach(function (e) {
  ...
  function Ps(e, t) {
    ...
    function F() {
      l.showHiddenSlides ||
        So(v.wrapper, 'section[data-visibility="hidden"]').forEach(function (
          e
        ) {
    ...
    function J(e) {
      'string' == typeof e.layout && (f.layout = e.layout),
        ...
        f.layout
          ? Ao(v.slides, f.layout + ' ' + f.overview)
          : Ao(v.slides, f.overview)
    }
    function Q(e) {
      var t = e.target,
    ...
    function oe() {
      if (v.wrapper && !I.isPrintingPDF()) {
        if (!l.disableLayout) {
          ...
          for (
            var n = Array.from(v.wrapper.querySelectorAll(lo)),
              i = 0,
              r = n.length;
            i < r;
            i++
    ...
    function se(e, t) {
      So(v.slides, 'section > .stretch, section > .r-stretch').forEach(
        function (n) {
          var i = No(n, t)
    ...
    function Le() {
      ...
      if (r && void 0 !== n) {
        ...
        Oo && (a = R.isActive() ? 6 : l.mobileViewDistance),
    ...
    function Me(e) {
      ...
      if (e) {
        ...
        ;(r = Math.max(u.indexOf(l), 0)),
          (o = void 0),
          s && (o = Math.max(So(e.parentNode, 'section').indexOf(e), 0))
      }
    ...
    function Je() {
      ;(c.hasNavigatedVertically = !0),
        (R.isActive() || !1 === A.next()) && Ce().down && Se(n, i + 1)
    }
    function Qe() {
      var e
      if (!1 === A.prev())
        if (Ce().up) Ge()
          ...
          (e = l.rtl
            ? So(v.wrapper, '.slides>section.future').pop()
            : So(v.wrapper, '.slides>section.past').pop())
        ) {
