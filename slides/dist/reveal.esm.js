...
var n,
  ...
  S = function (e, t) {
    if (!p(e)) return e
    var i, n
    if (t && 'function' == typeof (i = e.toString) && !p((n = i.call(e))))
      return n
  ...
  T = function (e) {
    return (
      'Symbol(' + String(void 0 === e ? '' : e) + ')_' + (++M + I).toString(36)
    )
  },
  D =
  ...
  U = function (e) {
    return (
      N(z, e) || (D && N(H, e) ? (z[e] = H[e]) : (z[e] = B('Symbol.' + e))),
      z[e]
    )
  },
  j = Math.ceil,
  ...
  ee = v
    ...
    : function (e, t) {
        w(e)
        for (var i, n = Z(t), a = n.length, s = 0; a > s; )
          R.f(e, (i = n[s++]), t[i])
        return e
      },
  te = s,
...
;[].keys &&
  ('next' in (Ne = [].keys())
    ? (Pe = it(it(Ne))) !== Object.prototype && (Ce = Pe)
    : (at = !0)),
  null == Ce && (Ce = {}),
  N(Ce, nt) ||
    k(Ce, nt, function () {
...
var st = { IteratorPrototype: Ce, BUGGY_SAFARI_ITERATORS: at },
  ...
  lt = function (e, t, i) {
    e &&
      !N((e = i ? e : e.prototype), ot) &&
      rt(e, ot, { configurable: !0, value: t })
  },
    ...
    if (
      (f &&
        ...
        ut !== Object.prototype &&
          o.next &&
          (it(o) !== ut &&
            (ct ? ct(o, ut) : 'function' != typeof o[gt] && k(o, gt, vt)),
          lt(o, u, !0))),
      'values' == a &&
        v &&
        'values' !== v.name &&
...
const ei = (e, t) => {
  ...
  gi =
    /(iphone|ipod|ipad|android)/gi.test(ui) ||
    ...
    t.default = (function (e) {
      ...
      function P(e) {
        ...
        return 'string' == typeof e
          ? C(t(document.querySelectorAll(e)), i)
          : C([e], i)[0]
      }
...
class bi {
  ...
  load(e, t = {}) {
    ...
    Array.from(e.querySelectorAll('.r-fit-text:not([data-fitted])')).forEach(
      (e) => {
        ;(e.dataset.fitted = ''),
          mi(e, {
            minSize: 24,
  ...
  unload(e) {
    ...
    t &&
      ...
      ti(e, 'video[data-lazy-loaded] source[src], audio source[src]').forEach(
        (e) => {
          e.setAttribute('data-src', e.getAttribute('src')),
            e.removeAttribute('src')
        }
    ...
    e &&
      ...
      ti(e, 'video, audio').forEach((e) => {
        ...
        if (
          ('boolean' != typeof t &&
            (t =
              e.hasAttribute('data-autoplay') || !!ri(e, '.slide-background')),
  ...
  startEmbeddedIframe(e) {
    ...
    if (t && t.contentWindow) {
      ...
      if (i && n) {
        ...
        'boolean' != typeof e &&
          (e = t.hasAttribute('data-autoplay') || !!ri(t, '.slide-background')),
...
class Ri {
  ...
  reset() {
    ti(
      ...
      ti(this.Reveal.getRevealElement(), '[data-auto-animate-target]').forEach(
        (e) => {
  ...
  autoAnimateElements(e, t, i, n, a) {
    ...
    if (
      ...
      ;(e.className.match(Lt) || [''])[0] ===
        (t.className.match(Lt) || [''])[0] &&
  ...
  deactivate() {
    if (this.Reveal.getConfig().overview) {
      ;(this.active = !1),
        ...
        ti(this.Reveal.getBackgroundsElement(), '.slide-background').forEach(
          (e) => {
            ai(e, '')
          }
        ),
...
class Ti {
  ...
  setupPDF() {
    ...
    ti(this.Reveal.getRevealElement(), '.slides section').forEach(function (e) {
      ...
      ti(this.Reveal.getRevealElement(), '.slides section').forEach(function (
        t
      ) {
...
function Ui(e, t) {
  ...
  function X() {
    window.addEventListener('resize', it, !1),
      ...
      l.focusBodyOnPageVisibilityChange &&
        document.addEventListener('visibilitychange', nt, !1)
  }
  function $() {
    D.unbind(),
      T.unbind(),
  ...
  function J(e) {
    'string' == typeof e.layout && (g.layout = e.layout),
      ...
      g.layout
        ? ai(v.slides, g.layout + ' ' + g.overview)
        : ai(v.slides, g.overview)
  }
  ...
  function ve() {
    return (
      ...
      (!ue(r) || !r.parentNode.nextElementSibling)
    )
  }
  function pe() {
    if (l.pause) {
  ...
  function xe() {
    ...
    if (s && void 0 !== n) {
      ...
      gi && (r = k.isActive() ? 6 : l.mobileViewDistance),
  ...
  function Me(e) {
    ...
    if (e) {
      ...
      ;(i = Math.max(a.indexOf(n), 0)),
        (s = void 0),
        t && (s = Math.max(ti(e.parentNode, 'section').indexOf(e), 0))
    }
    if (!e && r) {
    ...
    if ((Ve(), r && !1 !== l.autoSlide)) {
      ...
      t
        ...
        !f ||
          ...
          ((m = setTimeout(() => {
            'function' == typeof l.autoSlideMethod ? l.autoSlideMethod() : Ze(),
              _e()
          }, f)),
          (b = Date.now())),
        o && o.setPlaying(-1 !== m)
  ...
  function $e() {
    ;(c.hasNavigatedHorizontally = !0),
      l.rtl
        ? (k.isActive() || !1 === A.next()) &&
          Ce().left &&
          Se(n + 1, 'grid' === l.navigationMode ? a : void 0)
        : (k.isActive() || !1 === A.prev()) &&
          Ce().left &&
          Se(n - 1, 'grid' === l.navigationMode ? a : void 0)
  }
  ...
  function Je() {
    ;(c.hasNavigatedVertically = !0),
      (k.isActive() || !1 === A.next()) && Ce().down && Se(n, a + 1)
  }
  function Qe() {
    if (!1 === A.prev())
      if (Ce().up) Ge()
        ...
        if (
          ((e = l.rtl
            ? ti(v.wrapper, '.slides>section.future').pop()
            : ti(v.wrapper, '.slides>section.past').pop()),
          e)
        ) {
